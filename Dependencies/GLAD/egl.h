/**
 * Loader generated by glad 2.0.6 on Fri Aug 23 12:47:34 2024
 *
 ...
 * Commandline:
 *    --api='egl=1.5'
 * --extensions='EGL_KHR_cl_event2,EGL_KHR_fence_sync,EGL_KHR_image,EGL_KHR_image_base,EGL_KHR_reusable_sync'
 * c --alias
 *
 * Online:
 *    http://glad.sh/#api=egl%3D1.5&extensions=EGL_KHR_cl_event2%2CEGL_KHR_fence_sync%2CEGL_KHR_image%2CEGL_KHR_image_base%2CEGL_KHR_reusable_sync&generator=c&options=ALIAS
 *
 */
...
#include "khrplatform.h"
    ...
    typedef EGLsizeiANDROID (*EGLGetBlobFuncANDROID)(
    ...
    typedef void(GLAD_API_PTR* EGLDEBUGPROCKHR)(EGLenum error,
                                                const char* command,
                                                EGLint messageType,
...
#define EGL_KHR_reusable_sync 1
    ...
    typedef EGLBoolean(GLAD_API_PTR* PFNEGLBINDTEXIMAGEPROC)(
    ...
    typedef EGLint(GLAD_API_PTR* PFNEGLCLIENTWAITSYNCPROC)(
    ...
    typedef EGLSurface(
        GLAD_API_PTR* PFNEGLCREATEPBUFFERFROMCLIENTBUFFERPROC)(
    ...
    typedef EGLSurface(GLAD_API_PTR* PFNEGLCREATEPIXMAPSURFACEPROC)(
        ...
        const EGLint* attrib_list);
    typedef EGLSurface(
        GLAD_API_PTR* PFNEGLCREATEPLATFORMPIXMAPSURFACEPROC)(
        EGLDisplay dpy, EGLConfig config, void* native_pixmap,
        const EGLAttrib* attrib_list);
    typedef EGLSurface(
        GLAD_API_PTR* PFNEGLCREATEPLATFORMWINDOWSURFACEPROC)(
    ...
    typedef EGLSurface(GLAD_API_PTR* PFNEGLCREATEWINDOWSURFACEPROC)(
        ...
        const EGLint* attrib_list);
    typedef EGLBoolean(GLAD_API_PTR* PFNEGLDESTROYCONTEXTPROC)(
        EGLDisplay dpy, EGLContext ctx);
    typedef EGLBoolean(GLAD_API_PTR* PFNEGLDESTROYIMAGEPROC)(
    ...
    typedef EGLBoolean(GLAD_API_PTR* PFNEGLDESTROYSYNCPROC)(EGLDisplay dpy,
                                                            EGLSync sync);
    typedef EGLBoolean(GLAD_API_PTR* PFNEGLDESTROYSYNCKHRPROC)(
        EGLDisplay dpy, EGLSyncKHR sync);
    typedef EGLBoolean(GLAD_API_PTR* PFNEGLGETCONFIGATTRIBPROC)(
        EGLDisplay dpy, EGLConfig config, EGLint attribute, EGLint* value);
    typedef EGLBoolean(GLAD_API_PTR* PFNEGLGETCONFIGSPROC)(
    ...
    typedef EGLBoolean(GLAD_API_PTR* PFNEGLINITIALIZEPROC)(EGLDisplay dpy,
                                                           EGLint* major,
                                                           EGLint* minor);
    typedef EGLBoolean(GLAD_API_PTR* PFNEGLMAKECURRENTPROC)(
        EGLDisplay dpy, EGLSurface draw, EGLSurface read, EGLContext ctx);
    typedef EGLenum(GLAD_API_PTR* PFNEGLQUERYAPIPROC)(void);
    typedef EGLBoolean(GLAD_API_PTR* PFNEGLQUERYCONTEXTPROC)(
        EGLDisplay dpy, EGLContext ctx, EGLint attribute, EGLint* value);
    typedef const char*(GLAD_API_PTR* PFNEGLQUERYSTRINGPROC)(
        EGLDisplay dpy, EGLint name);
    typedef EGLBoolean(GLAD_API_PTR* PFNEGLQUERYSURFACEPROC)(
        EGLDisplay dpy, EGLSurface surface, EGLint attribute,
        EGLint* value);
    typedef EGLBoolean(GLAD_API_PTR* PFNEGLRELEASETEXIMAGEPROC)(
        EGLDisplay dpy, EGLSurface surface, EGLint buffer);
    typedef EGLBoolean(GLAD_API_PTR* PFNEGLRELEASETHREADPROC)(void);
    typedef EGLBoolean(GLAD_API_PTR* PFNEGLSIGNALSYNCKHRPROC)(
        EGLDisplay dpy, EGLSyncKHR sync, EGLenum mode);
    typedef EGLBoolean(GLAD_API_PTR* PFNEGLSURFACEATTRIBPROC)(
        EGLDisplay dpy, EGLSurface surface, EGLint attribute,
        EGLint value);
    typedef EGLBoolean(GLAD_API_PTR* PFNEGLSWAPBUFFERSPROC)(
        EGLDisplay dpy, EGLSurface surface);
    typedef EGLBoolean(GLAD_API_PTR* PFNEGLSWAPINTERVALPROC)(
...
#define eglCreatePbufferFromClientBuffer                                  \
    glad_eglCreatePbufferFromClientBuffer
    GLAD_API_CALL PFNEGLCREATEPBUFFERSURFACEPROC
        glad_eglCreatePbufferSurface;
#define eglCreatePbufferSurface glad_eglCreatePbufferSurface
    GLAD_API_CALL PFNEGLCREATEPIXMAPSURFACEPROC
...
#define eglCreateSyncKHR glad_eglCreateSyncKHR
    GLAD_API_CALL PFNEGLCREATEWINDOWSURFACEPROC
