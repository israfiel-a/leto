...
int _glfwInitNull(void)
{
    ...
    _glfw.null.keycodes[GLFW_NULL_SC_RIGHT_BRACKET] =
    ...
    _glfw.null.keycodes[GLFW_NULL_SC_RIGHT_CONTROL] =
    ...
    for (scancode = GLFW_NULL_SC_FIRST; scancode < GLFW_NULL_SC_LAST;
         scancode++)
    {
